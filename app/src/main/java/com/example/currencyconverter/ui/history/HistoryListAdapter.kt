...
import com.example.currencyconverter.core.extensions.formatCurrency
import com.example.currencyconverter.data.model.Currency
import com.example.currencyconverter.data.model.ExchangeResponseValue
import com.example.currencyconverter.databinding.ItemHistoryBinding
...
class HistoryListAdapter : ListAdapter<ExchangeResponseValue, HistoryListAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(
        ...
        fun bind(item: ExchangeResponseValue) {
            ...
            val currency = Currency.getByName(item.codein)
            binding.tvValue.text = item.bid.formatCurrency(currency.locale)
        }
    }
}
